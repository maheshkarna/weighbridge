$(document).ready(() => {
  ...
  app.cameraSettings = {
   ...
   //DVR Camera Data
    ...
    console.log(data);
    $.when(
        app.database.tables.bmrCameraSettings.insertCamData(data)
    ).done(function(){
      toastr.options = {
  ...
  CheckCamData: () => {
      ...
      $.when(
        app.database.tables.bmrCameraSettings.getCamData()
      ).done(function (data) {   
        console.log(data);  
  ...
  updateCamerasData:() =>{
   ...
   //DVR Camera Data
    ...
    console.log(data);
    $.when(
        app.database.tables.bmrCameraSettings.updateCamData(data)
    ).done(function(){
      toastr.options = {
        positionClass: 'toast-bottom-right'
       };
